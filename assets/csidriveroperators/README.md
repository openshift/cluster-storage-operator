...
Historically, these operators have lived in their own repositories, but
starting in 4.16 they have been migrating to the `openshift/csi-operator`
repository.

If the driver has added support for Hypershift deployments, you find the
