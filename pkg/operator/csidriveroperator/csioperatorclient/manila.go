...
func GetManilaOperatorConfig(clients *csoclients.Clients, recorder events.Recorder) CSIOperatorConfig {
	...
	return CSIOperatorConfig{
		...
		OLMOptions: &OLMOptions{
			CSIDriverNamespace:        "openshift-manila-csi-driver",
			CSIDriverDeploymentName:   "openstack-manila-csi-controllerplugin",
			CSIDriverDaemonSetName:    "openstack-manila-csi-nodeplugin",
