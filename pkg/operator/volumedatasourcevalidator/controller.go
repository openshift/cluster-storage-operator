...
func (c *VolumeDataSourceValidatorStarter) createVolumeDataSourceValidatorManager(
	...
	staticAssets := []string{
		"volumedatasourcevalidator/serviceaccount.yaml",
		"volumedatasourcevalidator/clusterrole.yaml",
		"volumedatasourcevalidator/clusterrolebinding.yaml",
		"volumedatasourcevalidator/volumedatasourcevalidator.yaml",
	}
	...
	deploymentAssets, err := assets.ReadFile("volumedatasourcevalidator/deployment.yaml")
	if err != nil {
		panic(err)
	}
