...
COPY vendor/github.com/openshift/api/operator/v1/0000_90_cluster_csi_driver_01_config-Default.crd.yaml manifests/04_cluster_csi_driver_crd-Default.yaml
COPY vendor/github.com/openshift/api/operator/v1/0000_90_cluster_csi_driver_01_config-CustomNoUpgrade.crd.yaml manifests/04_cluster_csi_driver_crd-CustomNoUpgrade.yaml
COPY vendor/github.com/openshift/api/operator/v1/0000_90_cluster_csi_driver_01_config-TechPreviewNoUpgrade.crd.yaml manifests/04_cluster_csi_driver_crd-TechPreviewNoUpgrade.yaml
